...
public class GT_GUIContainer_RedstoneCircuitBlock extends GT_GUIContainerMetaTile_Machine {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
    	...
    	if (tCircuit != null) {
    		fontRendererObj.drawString(tCircuit.getName()       , 46,  8, 16448255);
    		fontRendererObj.drawString(tCircuit.getDescription(), 46, 19, 16448255);
    		
    		fontRendererObj.drawString(tCircuit.getDataDescription(((GT_Container_RedstoneCircuitBlock)mContainer).mData, 0), 46, 33, 16448255);
    		fontRendererObj.drawString(tCircuit.getDataDescription(((GT_Container_RedstoneCircuitBlock)mContainer).mData, 1), 46, 44, 16448255);
    		fontRendererObj.drawString(tCircuit.getDataDescription(((GT_Container_RedstoneCircuitBlock)mContainer).mData, 2), 46, 55, 16448255);
    		fontRendererObj.drawString(tCircuit.getDataDescription(((GT_Container_RedstoneCircuitBlock)mContainer).mData, 3), 46, 66, 16448255);
    		
    		String tString;
    		tString = tCircuit.getDataDisplay(((GT_Container_RedstoneCircuitBlock)mContainer).mData, 0);
    		fontRendererObj.drawString(tString==null?toNumber(((GT_Container_RedstoneCircuitBlock)mContainer).mData[0]):tString, 99, 33, 16448255);
    		tString = tCircuit.getDataDisplay(((GT_Container_RedstoneCircuitBlock)mContainer).mData, 1);
    		fontRendererObj.drawString(tString==null?toNumber(((GT_Container_RedstoneCircuitBlock)mContainer).mData[1]):tString, 99, 44, 16448255);
    		tString = tCircuit.getDataDisplay(((GT_Container_RedstoneCircuitBlock)mContainer).mData, 2);
    		fontRendererObj.drawString(tString==null?toNumber(((GT_Container_RedstoneCircuitBlock)mContainer).mData[2]):tString, 99, 55, 16448255);
    		tString = tCircuit.getDataDisplay(((GT_Container_RedstoneCircuitBlock)mContainer).mData, 3);
    		fontRendererObj.drawString(tString==null?toNumber(((GT_Container_RedstoneCircuitBlock)mContainer).mData[3]):tString, 99, 66, 16448255);
    	}
    }
