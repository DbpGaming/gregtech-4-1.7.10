...
public class GT_GUIContainer_ThermalGenerator extends GT_GUIContainerMetaTile_Machine {
    ...
    public GT_GUIContainer_ThermalGenerator(InventoryPlayer aInventoryPlayer, IGregTechTileEntity aTileEntity, int aID) {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        fontRendererObj.drawString("Thermal Generator", 8, 6, 4210752);
        if (mContainer != null) {
