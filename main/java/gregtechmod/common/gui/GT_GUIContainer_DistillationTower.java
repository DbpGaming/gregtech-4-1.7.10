...
public class GT_GUIContainer_DistillationTower extends GT_GUIContainerMetaTile_Machine {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        fontRendererObj.drawString("Distillation"		, 116,  4, 4210752);
        fontRendererObj.drawString("Tower"				, 116, 12, 4210752);
        if (!((GT_Container_DistillationTower)mContainer).mMachine) {
        	fontRendererObj.drawString("Incomplete"	, 116, 20, 4210752);
        	fontRendererObj.drawString("Machine"		, 116, 28, 4210752);
        	fontRendererObj.drawString("Casing!"		, 116, 36, 4210752);
        }
        if (((mContainer).mDisplayErrorCode & 1) != 0) {
        	fontRendererObj.drawString("Insufficient"	, 116, 44, 4210752);
        	fontRendererObj.drawString("Energy"		, 116, 52, 4210752);
        	fontRendererObj.drawString("Line!"			, 116, 60, 4210752);
        }
    }
