...
public class GT_GUIContainer_SteelBoiler extends GT_GUIContainerMetaTile_Machine {
    ...
    public GT_GUIContainer_SteelBoiler(InventoryPlayer aInventoryPlayer, IGregTechTileEntity aTileEntity, int aID) {
        super(new GT_Container_SteelBoiler(aInventoryPlayer, aTileEntity, aID), aTileEntity, aID, GregTech_API.GUI_PATH + "SteelBoiler.png");
    }
    
    @Override
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        fontRendererObj.drawString("High Pressure Coal Boiler", 8,  4, 4210752);
    }
