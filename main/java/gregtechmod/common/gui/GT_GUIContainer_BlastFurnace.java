...
public class GT_GUIContainer_BlastFurnace extends GT_GUIContainerMetaTile_Machine {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        fontRendererObj.drawString("Industrial Blast Furnace", 8,  4, 4210752);
        if (((GT_Container_BlastFurnace)mContainer).mMachine)
        	fontRendererObj.drawString("Heat Capacity: " + ((GT_Container_BlastFurnace)mContainer).mHeatCapacity + " K", 8, ySize - 103, 4210752);
        else
        	fontRendererObj.drawString("Incomplete Machine Casing!", 8, ySize - 103, 4210752);
