...
public class GT_GUIContainer_SemifluidGenerator extends GT_GUIContainerMetaTile_Machine {
    ...
    public GT_GUIContainer_SemifluidGenerator(InventoryPlayer aInventoryPlayer, IGregTechTileEntity aTileEntity, int aID) {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        fontRendererObj.drawString("Semifluid Generator", 8, 6, 4210752);
        if (mContainer != null) {
        	fontRendererObj.drawString("Liquid Amount", 10, 20, 16448255);
        	fontRendererObj.drawString(toNumber(((GT_Container_BasicTank)mContainer).mContent), 10, 30, 16448255);
        }
    }
