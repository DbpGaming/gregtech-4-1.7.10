...
public class GT_ItemIterator implements Runnable {
	...
	public void run() {
		...
		for (int i = 0; i < Items.itemsList.length; i++) if ((tItem = Items.itemsList[i]) != null && (tName = tItems.getUnlocalizedName()) != null) {
		    ...
		    if (tName.equals("Items.meefRaw") || tName.equals("Items.venisonRaw")) {
		    ...
		    if (tName.equals("Items.fieryBlood")) {
		    ...
		    if (tName.equals("Items.steeleafIngot")) {
		    ...
		    if (tName.equals("Items.fieryIngot")) {
			...
			if (tName.equals("Items.ItemWispEssence")) {
				GregTech_API.sRecipeAdder.addFuel(new ItemStack(tItem, 1,  7), new ItemStack(tItem, 1, 0),  80, 5);
				GregTech_API.sRecipeAdder.addFuel(new ItemStack(tItem, 1, 10), new ItemStack(tItem, 1, 0), 160, 5);
				GregTech_API.sRecipeAdder.addFuel(new ItemStack(tItem, 1, 41), new ItemStack(tItem, 1, 0), 120, 5);
			}
			if (tName.equals("Items.ItemResource")) {
			...
			if (tName.equals("Items.ItemShard")) {
			...
			if (tName.equals("Items.minotaurAxe")) {
			...
			if (tName.equals("Items.bucketFuel")) {
			...
			if (tName.equals("Items.drawplateDiamond"))	GT_ModHandler.mDiamondDrawplate	= new ItemStack(tItem, 1);
			
			if (tName.equals("Items.woodenGearItem"))	GT_ModHandler.mBCWoodGear		= new ItemStack(tItem, 1);
			if (tName.equals("Items.stoneGearItem"))		GT_ModHandler.mBCStoneGear		= new ItemStack(tItem, 1);
			if (tName.equals("Items.ironGearItem"))		GT_ModHandler.mBCIronGear		= new ItemStack(tItem, 1);
			if (tName.equals("Items.goldGearItem"))		GT_ModHandler.mBCGoldGear		= new ItemStack(tItem, 1);
			if (tName.equals("Items.diamondGearItem"))	GT_ModHandler.mBCDiamondGear	= new ItemStack(tItem, 1);
			
			if (tName.equals("Items.canLava"))			GregTech_API.sRecipeAdder.addCentrifugeRecipe(new ItemStack(tItem, 16), 0, GT_OreDictUnificator.get("ingotElectrum", 1), GT_OreDictUnificator.get("ingotCopper", 4), GT_OreDictUnificator.get("dustSmallTungsten", 1), GT_OreDictUnificator.get("ingotTin", 6), 15000);
			if (tName.equals("Items.refractoryLava"))	GregTech_API.sRecipeAdder.addCentrifugeRecipe(new ItemStack(tItem, 16), 0, GT_OreDictUnificator.get("ingotElectrum", 1), GT_OreDictUnificator.get("ingotCopper", 4), GT_OreDictUnificator.get("dustSmallTungsten", 1), GT_OreDictUnificator.get("ingotTin", 2), 10000);
		}
