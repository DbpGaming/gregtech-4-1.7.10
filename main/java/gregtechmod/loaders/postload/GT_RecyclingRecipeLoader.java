...
public class GT_RecyclingRecipeLoader implements Runnable {
	...
	public void run() {
        ...
        GT_ModHandler.addPulverisationRecipe(new ItemStack(Items.helmetChain, 1)			, GT_MetaItem_SmallDust.instance.getStack(26, 5), null, 0, true);
        GT_ModHandler.addPulverisationRecipe(new ItemStack(Items.plateChain, 1)			, GT_MetaItem_SmallDust.instance.getStack(26, 8), null, 0, true);
        GT_ModHandler.addPulverisationRecipe(new ItemStack(Items.legsChain, 1)			, GT_MetaItem_SmallDust.instance.getStack(26, 7), null, 0, true);
        GT_ModHandler.addPulverisationRecipe(new ItemStack(Items.bootsChain, 1)			, GT_MetaItem_SmallDust.instance.getStack(26, 4), null, 0, true);
        
        GT_ModHandler.addPulverisationRecipe(new ItemStack(Items.pocketSundial, 1)		, GT_OreDictUnificator.get("dustGold", 4), GT_OreDictUnificator.get("dustRedstone", 1), 95, false);
        ...
        GT_ModHandler.addPulverisationRecipe(new ItemStack(Items.minecartEmpty, 1)		, GT_OreDictUnificator.get("dustIron", 5), null, 0, true);
        GT_ModHandler.addPulverisationRecipe(new ItemStack(Items.bucketEmpty, 1)			, GT_OreDictUnificator.get("dustIron", 3), null, 0, true);
        GT_ModHandler.addPulverisationRecipe(new ItemStack(Items.doorIron, 1)			, GT_OreDictUnificator.get("dustIron", 6), null, 0, true);
        GT_ModHandler.addPulverisationRecipe(new ItemStack(Items.cauldron, 1)			, GT_OreDictUnificator.get("dustIron", 7), null, 0, true);
        GT_ModHandler.addPulverisationRecipe(new ItemStack(Blocks.fenceIron, 2)			, GT_MetaItem_SmallDust.instance.getStack(241, 3), null, 0, true);
        ...
        GT_ModHandler.addPulverisationRecipe(new ItemStack(Blocks.pressurePlateGold, 1)	, GT_OreDictUnificator.get("dustGold", 2), null, 0, true);
        GT_ModHandler.addPulverisationRecipe(new ItemStack(Blocks.pressurePlateIron, 1)	, GT_OreDictUnificator.get("dustIron", 2), null, 0, true);
        
        GT_ModHandler.addSmeltingAndAlloySmeltingRecipe(new ItemStack(Items.pocketSundial, 1)		, GT_OreDictUnificator.get("ingotGold", 4));
        ...
        GT_ModHandler.addSmeltingAndAlloySmeltingRecipe(new ItemStack(Items.minecartEmpty, 1)		, GT_OreDictUnificator.get("ingotIron", 5));
        GT_ModHandler.addSmeltingAndAlloySmeltingRecipe(new ItemStack(Items.bucketEmpty, 1)			, GT_OreDictUnificator.get("ingotIron", 3));
        GT_ModHandler.addSmeltingAndAlloySmeltingRecipe(new ItemStack(Items.doorIron, 1)				, GT_OreDictUnificator.get("ingotIron", 6));
        ...
        GT_ModHandler.addSmeltingAndAlloySmeltingRecipe(new ItemStack(Blocks.pressurePlateGold, 1)	, GT_OreDictUnificator.get("ingotGold", 2));
        GT_ModHandler.addSmeltingAndAlloySmeltingRecipe(new ItemStack(Blocks.pressurePlateIron, 1)	, GT_OreDictUnificator.get("ingotIron", 2));
        GT_ModHandler.addSmeltingAndAlloySmeltingRecipe(new ItemStack(Blocks.hopperBlock, 1)			, GT_OreDictUnificator.get("ingotIron", 5));
        ...
        GT_ModHandler.addPulverisationRecipe(new ItemStack(Blocks.enchantmentTable, 1), GT_OreDictUnificator.get("dustDiamond", 2), GT_OreDictUnificator.get("dustObsidian", 4), 95, false);
        GT_ModHandler.addPulverisationRecipe(new ItemStack(Blocks.furnaceIdle, 1), new ItemStack(Blocks.sand, 7), null, 0, false);
        GT_ModHandler.addPulverisationRecipe(new ItemStack(Blocks.furnaceBurning, 1), new ItemStack(Blocks.sand, 7), null, 0, false);
        GT_ModHandler.addPulverisationRecipe(new ItemStack(Blocks.stoneButton, 1), new ItemStack(Blocks.sand, 1), null, 0, false);
        GT_ModHandler.addPulverisationRecipe(new ItemStack(Items.sign, 1, 0), GT_OreDictUnificator.get("dustWood", 2), null, 0, false);
        GT_ModHandler.addPulverisationRecipe(new ItemStack(Items.doorWood, 1, 0), GT_OreDictUnificator.get("dustWood", 6), null, 0, false);
        GT_ModHandler.addPulverisationRecipe(new ItemStack(Blocks.chest, 1, 0), GT_OreDictUnificator.get("dustWood", 8), null, 0, false);
        GT_ModHandler.addPulverisationRecipe(new ItemStack(Blocks.woodenButton, 1, 0), GT_OreDictUnificator.get("dustWood", 1), null, 0, false);
        GT_ModHandler.addPulverisationRecipe(new ItemStack(Blocks.pressurePlateStone, 1), new ItemStack(Blocks.sand, 2), null, 0, false);
        GT_ModHandler.addPulverisationRecipe(new ItemStack(Blocks.pressurePlatePlanks, 1), GT_OreDictUnificator.get("dustWood", 2), null, 0, false);
        GT_ModHandler.addPulverisationRecipe(new ItemStack(Blocks.torchRedstoneActive, 1), GT_OreDictUnificator.get("dustSmallWood", 2), new ItemStack(Items.redstone, 1), 95, false);
        GT_ModHandler.addPulverisationRecipe(new ItemStack(Blocks.torchRedstoneIdle, 1), GT_OreDictUnificator.get("dustSmallWood", 2), new ItemStack(Items.redstone, 1), 95, false);
        ...
        GT_ModHandler.addPulverisationRecipe(new ItemStack(Items.itemFrame, 1, 0), new ItemStack(Items.leather, 1), GT_OreDictUnificator.get("dustWood", 4), 95, false);
        GT_ModHandler.addPulverisationRecipe(new ItemStack(Items.bow, 1, 0), new ItemStack(Items.silk, 3), GT_OreDictUnificator.get("dustSmallWood", 3), 95, false);
        
        //GT_ModHandler.addPulverisationRecipe(GT_ModHandler.getRecipeOutput(new ItemStack[] {new ItemStack(Items.ingotIron, 1), null, new ItemStack(Items.ingotIron, 1), new ItemStack(Items.ingotIron, 1), new ItemStack(Items.stick, 1), new ItemStack(Items.ingotIron, 1), new ItemStack(Items.ingotIron, 1), null, new ItemStack(Items.ingotIron, 1)}), GT_OreDictUnificator.get("dustIron", 6), GT_OreDictUnificator.get("dustSmallWood", 2), 95, false);
        //GT_ModHandler.addPulverisationRecipe(GT_ModHandler.getRecipeOutput(new ItemStack[] {new ItemStack(Items.ingotGold, 1), null, new ItemStack(Items.ingotGold, 1), new ItemStack(Items.ingotGold, 1), new ItemStack(Items.stick, 1), new ItemStack(Items.ingotGold, 1), new ItemStack(Items.ingotGold, 1), new ItemStack(Items.redstone, 1), new ItemStack(Items.ingotGold, 1)}), GT_OreDictUnificator.get("dustGold", 6), new ItemStack(Items.redstone, 1), 95, false);
