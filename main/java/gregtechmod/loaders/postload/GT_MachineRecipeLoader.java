...
public class GT_MachineRecipeLoader implements Runnable {
	...
	public void run() {
        ...
        GregTech_API.sRecipeAdder.addElectrolyzerRecipe(new ItemStack(Items.water_bucket, 1), 1, GT_ModHandler.getIC2Item("electrolyzedWaterCell", 1), null, null, new ItemStack(Items.bucket, 1), 215, 120);
		...
		GregTech_API.sRecipeAdder.addCannerRecipe(new ItemStack(Items.bucket), GT_ModHandler.getEmptyCell(1), GT_ModHandler.getWaterCell(1), new ItemStack(Items.bucket, 1), 100, 1);
    	...
    	GT_ModHandler.removeRecipe(new ItemStack[] {new ItemStack(Items.bucket), GT_ModHandler.getEmptyCell(1)});
		GT_ModHandler.removeRecipe(new ItemStack[] {new ItemStack(Items.bucket), GT_ModHandler.getEmptyCell(1)});
		...
		GregTech_API.sRecipeAdder.addCentrifugeRecipe(new ItemStack(Blocks.mycelium, 8), 0, new ItemStack(Blocks.brown_mushroom, 2), new ItemStack(Blocks.red_mushroom, 2), new ItemStack(Items.clay_ball, 1), new ItemStack(Blocks.sand, 4), 1650);
        ...
        GregTech_API.sRecipeAdder.addCentrifugeRecipe(new ItemStack(Blocks.brown_mushroom_block		, 12, GregTech_API.ITEM_WILDCARD_DAMAGE), 1, GT_MetaItem_Cell.instance.getStack(9, 1), null, null, null, 5000);
        GregTech_API.sRecipeAdder.addCentrifugeRecipe(new ItemStack(Blocks.red_mushroom_block		, 12, GregTech_API.ITEM_WILDCARD_DAMAGE), 1, GT_MetaItem_Cell.instance.getStack(9, 1), null, null, null, 5000);
        GregTech_API.sRecipeAdder.addCentrifugeRecipe(new ItemStack(Blocks.brown_mushroom		, 32), 1, GT_MetaItem_Cell.instance.getStack(9, 1), null, null, null, 5000);
        GregTech_API.sRecipeAdder.addCentrifugeRecipe(new ItemStack(Blocks.red_mushroom		, 32), 1, GT_MetaItem_Cell.instance.getStack(9, 1), null, null, null, 5000);
