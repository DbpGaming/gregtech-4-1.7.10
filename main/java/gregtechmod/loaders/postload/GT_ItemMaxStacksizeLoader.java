...
public class GT_ItemMaxStacksizeLoader implements Runnable {
	...
	public void run() {
    	...
    	if (GT_Mod.sPlankStackSize < 64) {
            ...
            Item.getItemFromBlock(Blocks.acacia_stairs).setMaxStackSize(GT_Mod.sPlankStackSize);
            Item.getItemFromBlock(Blocks.dark_oak_stairs).setMaxStackSize(GT_Mod.sPlankStackSize);
    	...
    	if (GT_Mod.sBlockStackSize < 64) {
            ...
            Item.getItemFromBlock(Blocks.packed_ice).setMaxStackSize(GT_Mod.sBlockStackSize);
            ...
            Item.getItemFromBlock(Blocks.trapped_chest).setMaxStackSize(GT_Mod.sBlockStackSize);
